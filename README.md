...
- **WED201c**: VSCode? Even [Notepad](https://en.wikipedia.org/wiki/Windows_Notepad) can be used for this subject. Just need browser to run.

### Semester 3

- **Lab211**: Oh yeah, *PRO192* but it is fun. I use Java btw.

- **CSD201**: Singly Linked List, Stack & Queue, Tree, and more. There is a source folder for Practical Exam (PE).

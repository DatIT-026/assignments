...
class dataList {
    ...
    void addLast(String code, int status, int size, int price) {
        ...
        if (isEmpty()) {
            ...
            if (newNode.info.getSize() > 0 && newNode.info.getPrice() > 0) {
                tail.next = newNode;
                tail = newNode;
            }
        }
...
//===========================================================================
    ...
    void rent(Room t) throws Exception {
        ...
        while (curr != null) {
            if (curr.info.getStatus() == 0 &&
                curr.info.getSize() >= t.getSize() &&
                curr.info.getPrice() <= t.getPrice()) {
                if (bestRoom == null || curr.info.getPrice() < bestRoom.getPrice()) {
                    bestRoom = curr.info;
                }
            }
            curr = curr.next;
    ...
    void f4() throws Exception {
        ...
        Node curr = dList.head;
        while (curr != null) {
            if (curr.info.getStatus() == 0) count++;
            curr = curr.next;
        }

...
//===========================================================================
    void insert(String xPlace, int xWeight, int xColor) {
        ...
        while (q != null) {
            if (q.info == newBird) return;
            if (q.info.weight < newBird.weight) {
                f = q;
                q = q.right;
            } else {
                f = q;
        ...
        else if (newNode.info.weight > f.info.weight) f.right = newNode;
        else f.left = newNode;
...
//=============================================================
    void f2() throws Exception {
        ...
        if (root != null && root.left != null) preOrder2(root.left, f);

 ...
 * @author datto
 */
public class CarErrorHandling implements Serializable {
    private String carIDFormatErr;
    private String duplicatedCarID;
    ...
    public CarErrorHandling() {
    }

    public CarErrorHandling(String carIDFormatErr, String duplicatedCarID, String carNameLengthErr, String manufacturerLengthErr, String priceFormatErr, String releasedYearFormatErr) {
        this.carIDFormatErr = carIDFormatErr;
        this.duplicatedCarID = duplicatedCarID;
    ...
    /**
     * @return the duplicatedCarID
     */
    public String getDuplicatedCarID() {
        return duplicatedCarID;
    }

    /**
     * @param duplicatedCarID the duplicatedCarID to set
     */
    public void setDuplicatedCarID(String duplicatedCarID) {
        this.duplicatedCarID = duplicatedCarID;
    }

<%-- 
    Document   : Search
    Created on : Jan 30, 2026, 9:11:03 PM
    Author     : datto
--%>
        ...
        <table border='1'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href=UserController?action=Delete&UserName=<%=user.getUserName()%>&txtSearchValue=<%=searchValue%>>Delete</td>
                    <td><a href=UserController?action=Details&UserName=<%=user.getUserName()%>&txtSearchValue=<%=searchValue%>>View</td>
                </tr>
                <%
                    }
                %>

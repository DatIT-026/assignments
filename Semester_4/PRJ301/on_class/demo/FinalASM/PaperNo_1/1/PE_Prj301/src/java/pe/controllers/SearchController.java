...
import pe.model.ItemDao;
import pe.model.ItemDto;
...
public class SearchController extends HttpServlet {
    ...
    private static final String LIST_PAGE = "listItem.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (minPriceStr != null && maxPriceStr != null) {
                    if (minPrice < 0 || maxPrice < 0) {
                        ...
                        errors.put("priceErr", "Min Price cannot be greater than Max Price!");
                    }

                    if (!errors.isEmpty()) {
                        request.setAttribute("err", errors);
                    } else {
                        dao.searchItem(minPrice, maxPrice);
                        isSearched = true;
                    }
                }
            ...
            if (isSearched) {
                List<ItemDto> result = dao.getItem();

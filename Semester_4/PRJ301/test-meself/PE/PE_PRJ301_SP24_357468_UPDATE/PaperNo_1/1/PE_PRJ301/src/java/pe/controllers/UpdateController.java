...
public class UpdateController extends HttpServlet {
    private static String UPDATE_PAGE = "update.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (sizeN < 0) {
                    errors.put("sizeErr", "Price must be a positive number!");
                }
            } catch (NumberFormatException e) {
                errors.put("sizeErr", "Price must be a valid number!");
            }
            ...
            if (!errors.isEmpty()) {
                ...
                if (result) {
                    url = "MainController?action=Search&paramSearchValue=" + lastSearchValue;
                }
            }

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (button != null && !button.equals("Login")) {
                if (session == null || session.getAttribute("WELCOME_MSG") == null) {
                    // Ép quay về login.jsp và có thể báo lỗi
                    request.setAttribute("INVALID", "Please login to continue!");
                    button = "InvalidAccess";
                }
            }

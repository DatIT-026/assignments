...
public class SearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.searchProductName(searchValue);
            List<ProductDTO> res = dao.getProduct();
            ...
            else url = USER_SEARCH_PAGE;
            
            
        } catch (ClassNotFoundException ex) {
            log("UserSearchServlett_ClassNotFound: " + ex.getMessage());
        } catch (SQLException ex) {
            log("UserSearchServlet_SQL: " + ex.getMessage());
        } catch (Exception ex) {
            log("UserSearchServlet: " + ex.getMessage());
        } finally {

 ...
 */
@Entity
@Table(name = "Registration", catalog = "PRJSE1922", schema = "dbo")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Registration.findAll", query = "SELECT r FROM Registration r"),
    @NamedQuery(name = "Registration.findByUsername", query = "SELECT r FROM Registration r WHERE r.username = :username"), // this :username is js placeholder
    ...
    @NamedQuery(name = "Registration.findLIKELastname", query = "SELECT r FROM Registration r WHERE r.lastname LIKE :lastname"),
...
public class Registration implements Serializable {
    ...
    public String toString() {
        return "cuongnh.registration.Registration[ username=" + username + " ]";
    }
